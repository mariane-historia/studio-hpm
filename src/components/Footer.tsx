      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://www.facebook.com/studiohpm"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/studiohpm/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E1FF01] hover:text-white transition-colors"
              ...
              <a
                href="https://www.linkedin.com/company/studiohpm/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-[#E1FF01] hover:text-white transition-colors"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-300">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:studiohpmplus@gmail.com" className="hover:text-[#E1FF01] transition-colors">
                  studiohpmplus@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-[#E1FF01] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+(63) 919 072 9684" className="hover:text-[#E1FF01] transition-colors">
                  +(63) 919 072 9684
                </a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Studio HPM+. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
